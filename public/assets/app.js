...
angular.module('app')
    .controller('centuryStatsCtrl', ["$scope", function($scope) {
      ...
      $scope.prepareLineGraph = function(centuryByYear,halfCenturyByYear){
          ...
          console.log(indexOfNoHalfcentury);
          console.log(indexOfNoCentury);
